...
// //one in jsonResponses.js (respondJSON()), responses.js (respond()), and client.html (conditional)
// //and how the pathnames change according to buttons rather than when we type it in
// //as well as how the format changes with typing it in and pressing the button**
